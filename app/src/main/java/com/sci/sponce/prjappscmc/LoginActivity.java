...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtUsuario = (AutoCompleteTextView) findViewById(R.id.email);
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(txtUsuario, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
        ...
        try {
            if (adminBL.getCreateDB(getApplicationContext())) {
                ...
                if (usuario.getIdUsuario() != 0) {
                    ...
                    msg = "Mensaje de Información: Error al ingresar las Credenciales";
                    flag = false;
                }
